...
## Add Horizon Aid Testing Users

To add testing users for each default user role in Horizon Aid.

```
cd PROJECT_DIR_NAME/recipes/horizonaid/scripts
...
## Delete Horizon Aid Testing Users
