...
//
// Run against any Horizon Aid install by setting LAUNCH_URL:
//   LAUNCH_URL=https://my-horizonaid.ddev.site yarn test:chromium
//
...
module.exports = {
  default: {
    ...
    require: [
      ...
      'tests/step-definitions/**/*.js',                                  // Horizon Aid custom step definitions.
    ],
    ...
    worldParameters: {
      ...
      minWaitTime: {
        // Per-navigation settle budget. Horizon Aid is built on Varbase (Gin admin
        // + AI widgets); 8s gives slow admin pages time to render before the
